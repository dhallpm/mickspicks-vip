...
const free = [
  { Date:'2026-07-10', Sport:'Basketball', League:'WNBA', Game:'Connecticut Sun vs Golden State Valkyries', Pick:'Over 153.5', 'Bet Type':'Game Total', Grade:'B+', Units:'0.75', 'Best Number':'153.5', 'No-Bet Cutoff':'155.5', Confidence:'7.8/10', Status:'Pending', Access:'Free', 'Official Bet':'Yes', Writeup:'The supporting model projects a total near 160, leaving value over the posted number.' },
  { Date:'2026-07-10', Sport:'Basketball', League:'NBA Summer League', Game:'Chicago Bulls vs Memphis Grizzlies', Pick:'Memphis Grizzlies ML', 'Bet Type':'Moneyline', Grade:'B+', Units:'0.75', 'No-Bet Cutoff':'-175', Confidence:'7.6/10', Status:'Pending', Access:'Free', 'Official Bet':'Yes', Writeup:'Memphis has the stronger projected roster and better continuity. The moneyline is preferred over laying six points.' },
  { Date:'2026-07-10', Sport:'Basketball', League:'NBA Summer League', Game:'Miami Heat vs Milwaukee Bucks', Pick:'Milwaukee Bucks ML', 'Bet Type':'Moneyline', Odds:'-120', Grade:'B', Units:'0.50', 'No-Bet Cutoff':'-135', Confidence:'7.2/10', Status:'Pending', Access:'Free', 'Official Bet':'Yes', Writeup:'Milwaukee projects to have the stronger top-end Summer League roster.' },
  { Date:'2026-07-10', Sport:'Basketball', League:'NBA Summer League', Game:'Toronto Raptors vs Boston Celtics', Pick:'Toronto Raptors -2.5', 'Bet Type':'Spread', Grade:'B', Units:'0.50', 'Best Number':'-2.5', 'No-Bet Cutoff':'-4', Confidence:'7.0/10', Status:'Pending', Access:'Free', 'Official Bet':'Yes', Writeup:'Toronto has a slight projected roster edge and the spread remains short.' },
  { Date:'2026-07-10', Sport:'Basketball', League:'NBA Summer League', Game:'Indiana Pacers vs Cleveland Cavaliers', Pick:'Cleveland Cavaliers -5', 'Bet Type':'Spread', Grade:'B-', Units:'0.50', 'Best Number':'-5', 'No-Bet Cutoff':'-6', Confidence:'6.8/10', Status:'Pending', Access:'Free', 'Official Bet':'Yes', Writeup:'Cleveland projects with better depth and defensive structure, but the five-point spread adds late-game risk.' }
]

const propsLab = [
  { Date:'2026-07-10', Sport:'Soccer', League:'FIFA World Cup', Game:'Spain vs Belgium', Pick:'Over 2.5 Goals', Prop:'Over 2.5 Goals', Category:'Game Prop', Odds:'-125', Grade:'B+', Units:'0.50', Confidence:'7.7/10', Status:'Pending', Access:'Free', 'Official Bet':'Yes', Writeup:'Belgium’s attacking form and Spain’s chance creation support a higher-scoring quarterfinal.' },
  { Date:'2026-07-10', Sport:'Soccer', League:'FIFA World Cup', Game:'Spain vs Belgium', Pick:'Both Teams to Score - Yes', Prop:'Both Teams to Score - Yes', Category:'Game Prop', Odds:'-125', Grade:'B', Units:'0.50', Confidence:'7.3/10', Status:'Pending', Access:'Free', 'Official Bet':'Yes', Writeup:'Belgium has enough attacking quality to contribute while Spain should create multiple chances.' },
  { Date:'2026-07-10', Sport:'Soccer', League:'FIFA World Cup', Game:'Spain vs Belgium', Pick:'Lamine Yamal Anytime Scorer', Player:'Lamine Yamal', Prop:'Anytime Scorer', Odds:'+170', Grade:'B', Units:'0.50', Confidence:'7.1/10', Status:'Pending', Access:'Free', 'Official Bet':'Yes', Writeup:'Spain should control attacking territory and the plus-money price provides sufficient upside.' },
  { Date:'2026-07-10', Sport:'Basketball', League:'WNBA', Game:'Dallas Wings vs Toronto Tempo', Pick:'Paige Bueckers Over 5 Assists', Player:'Paige Bueckers', Prop:'Over 5 Assists', Odds:'-120', Grade:'B', Units:'0.50', Confidence:'7.2/10', Status:'Pending', Access:'Free', 'Official Bet':'Yes', Writeup:'Bueckers’ recent assist production and prior matchup support the over.' }
]

const lottoParlays = [
  { Date:'2026-07-10', Sport:'Multi-Sport', League:'World Cup / WNBA / NBA Summer League', Game:'Spain vs Belgium; Sky vs Sparks; Bulls vs Grizzlies', Pick:'Spain to Advance + Sparks ML + Grizzlies ML', 'Bet Type':'3-Leg Parlay', Grade:'B+', Units:'0.50', Confidence:'7.7/10', Status:'Pending', Access:'VIP', Featured:'Yes', 'Official Bet':'Yes', Writeup:'The parlay combines the strongest knockout advancement position, the best-supported WNBA moneyline edge, and Memphis without laying Summer League points.' },
  { Date:'2026-07-10', Sport:'Multi-Sport', League:'World Cup / WNBA', Game:'Spain vs Belgium; Sky vs Sparks', Pick:'Spain to Advance + Sparks ML', 'Bet Type':'2-Leg Parlay', Grade:'A-', Units:'0.75', Confidence:'8.3/10', Status:'Pending', Access:'VIP', Featured:'Yes', 'Official Bet':'Yes', Writeup:'Safer two-leg version using the two VIP moneyline-style positions.' }
]

const longshots = [
  { Date:'2026-07-10', Sport:'Soccer', League:'FIFA World Cup', Game:'Spain vs Belgium', Pick:'Kevin De Bruyne Anytime Scorer', Player:'Kevin De Bruyne', Prop:'Anytime Scorer', Odds:'+475', Grade:'C+', Units:'0.20', Confidence:'5.8/10', Status:'Pending', Access:'Free', 'Official Bet':'Yes', Writeup:'A small lottery-style exposure at a large plus price.' },
  { Date:'2026-07-10', Sport:'Soccer', League:'FIFA World Cup', Game:'Spain vs Belgium', Pick:'Charles De Ketelaere Anytime Scorer', Player:'Charles De Ketelaere', Prop:'Anytime Scorer', Odds:'+495', Grade:'C+', Units:'0.20', Confidence:'5.6/10', Status:'Pending', Access:'Free', 'Official Bet':'Yes', Writeup:'A small lottery-style scorer position at a large plus price.' }
]

const rows = [...vip, ...free, ...propsLab, ...lottoParlays, ...longshots]
