...
const july11 = [
  { date:'2026-07-11', section:'VIP', access:'VIP', sport:'Soccer', league:'FIFA World Cup', game:'England vs Norway', pick:'England to Advance', odds:'-220', grade:'A-', units:'1.00u', result:'Win', profitLoss:'+0.45u', 'Profit/Loss':'+0.45u', status:'Graded', settlementNotes:'England won 2-1 and advanced.' },
  { date:'2026-07-11', section:'VIP', access:'VIP', sport:'Soccer', league:'FIFA World Cup', game:'Argentina vs Switzerland', pick:'Argentina to Advance', odds:'-290', grade:'A-', units:'1.00u', result:'Win', profitLoss:'+0.34u', 'Profit/Loss':'+0.34u', status:'Graded', settlementNotes:'Argentina won 3-1 and advanced.' },
  { date:'2026-07-11', section:'Free', access:'Free', sport:'MLB', league:'MLB', game:'Arizona Diamondbacks vs Los Angeles Dodgers', pick:'Los Angeles Dodgers -1.5', odds:'-125', grade:'B+', units:'0.75u', result:'Loss', profitLoss:'-0.75u', 'Profit/Loss':'-0.75u', status:'Graded' },
  { date:'2026-07-11', section:'Free', access:'Free', sport:'MLB', league:'MLB', game:'New York Yankees vs Washington Nationals', pick:'New York Yankees -1.5', odds:'-122', grade:'B', units:'0.50u', result:'Win', profitLoss:'+0.41u', 'Profit/Loss':'+0.41u', status:'Graded', settlementNotes:'New York covered the -1.5 run line.' },
  { date:'2026-07-11', section:'Free', access:'Free', sport:'WNBA', league:'WNBA', game:'Portland Fire vs Atlanta Dream', pick:'Atlanta Dream -13.5', odds:'-110', grade:'B', units:'0.50u', result:'Loss', profitLoss:'-0.50u', 'Profit/Loss':'-0.50u', status:'Graded', settlementNotes:'Atlanta lost outright.' },
  ...
  { date:'2026-07-11', section:'Free', access:'Free', sport:'WNBA', league:'WNBA', game:'Phoenix Mercury vs Las Vegas Aces', pick:'Over 170.5', odds:'-110', grade:'B', units:'0.50u', result:'Win', profitLoss:'+0.45u', 'Profit/Loss':'+0.45u', status:'Graded', settlementNotes:'The game finished over 170.5.' },
  { date:'2026-07-11', section:'Free', access:'Free', sport:'Basketball', league:'NBA Summer League', game:'Miami Heat vs Orlando Magic', pick:'Orlando Magic -4.5', odds:'-110', grade:'B', units:'0.50u', result:'Win', profitLoss:'+0.45u', 'Profit/Loss':'+0.45u', status:'Graded', settlementNotes:'Orlando won by 5 and covered -4.5.' },
  { date:'2026-07-11', section:'Free', access:'Free', sport:'Basketball', league:'NBA Summer League', game:'Denver Nuggets vs Minnesota Timberwolves', pick:'Minnesota Timberwolves -4.5', odds:'-117', grade:'B+', units:'0.75u', result:'Loss', profitLoss:'-0.75u', 'Profit/Loss':'-0.75u', status:'Graded' },
  { date:'2026-07-11', section:'Props Lab', access:'Free', sport:'Soccer', league:'FIFA World Cup', game:'England vs Norway', pick:'Both Teams to Score - Yes', odds:'-110', grade:'B', units:'0.50u', result:'Win', profitLoss:'+0.45u', 'Profit/Loss':'+0.45u', status:'Graded', settlementNotes:'England won 2-1; both teams scored.' },
  { date:'2026-07-11', section:'Props Lab', access:'Free', sport:'Soccer', league:'FIFA World Cup', game:'Argentina vs Switzerland', pick:'Argentina Team Total Over 1.5', odds:'-115', grade:'B+', units:'0.50u', result:'Win', profitLoss:'+0.43u', 'Profit/Loss':'+0.43u', status:'Graded', settlementNotes:'Argentina scored 3 goals.' },
  ...
  { date:'2026-07-11', section:'Props Lab', access:'Free', sport:'WNBA', league:'WNBA', game:'Phoenix Mercury vs Las Vegas Aces', pick:'A’ja Wilson Over 24.5 Points', odds:'-110', grade:'B+', units:'0.50u', result:'Loss', profitLoss:'-0.50u', 'Profit/Loss':'-0.50u', status:'Graded', settlementNotes:'Wilson finished with 21 points.' },
  { date:'2026-07-11', section:'Props Lab', access:'Free', sport:'WNBA', league:'WNBA', game:'Phoenix Mercury vs Las Vegas Aces', pick:'A’ja Wilson Over 9.5 Rebounds', odds:'-110', grade:'B', units:'0.50u', result:'Win', profitLoss:'+0.45u', 'Profit/Loss':'+0.45u', status:'Graded', settlementNotes:'Wilson finished with 15 rebounds.' },
  { date:'2026-07-11', section:'Lotto Parlays', access:'VIP', sport:'Soccer', league:'FIFA World Cup', game:'England vs Norway; Argentina vs Switzerland', pick:'England to Advance + Argentina to Advance', odds:'-105 derived', grade:'B+', units:'0.50u', result:'Win', profitLoss:'+0.48u', 'Profit/Loss':'+0.48u', status:'Graded', settlementNotes:'Both advancement legs won. Profit calculated from posted leg prices of -220 and -290.' },
  { date:'2026-07-11', section:'Lotto Parlays', access:'Free', sport:'WNBA / NBA Summer League', league:'WNBA / NBA Summer League', game:'Mercury vs Aces; Nuggets vs Timberwolves', pick:'Minnesota Timberwolves -4.5 + Mercury/Aces Over 170.5', odds:'TBD', grade:'B', units:'0.25u', result:'Loss', profitLoss:'-0.25u', 'Profit/Loss':'-0.25u', status:'Graded', settlementNotes:'The total won, but Minnesota -4.5 lost.' }
]
...
export default async function handler(req, res) {
  ...
  res.status(200).json({
    ok:true, success:true, source:'graded-results-through-july-11-2026-final', sourceOfTruth:'Micks Picks Final Grading', date:'2026-07-11',
    ...
    summary:{record:stats.record,units:stats.units,profitLoss:stats.profitLoss,winRate:stats.winRate,totalPicks:results.length,gradedPicks:results.length,note:'July 11 final grading: 10-6-1, +1.19u including both lotto parlays.'}
  })
}
