...
export default async function handler(req, res) {
  ...
  res.status(200).json({
    ...
    summary:{record:stats.record,units:stats.units,profitLoss:stats.profitLoss,winRate:stats.winRate,totalPicks:results.length,gradedPicks:results.length,note:'Known units exclude two winning parlays whose posted odds were not stored.'}
  })
}
