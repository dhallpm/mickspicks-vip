...
const july10 = [
  ...
  { date:'2026-07-10', section:'Free', access:'Free', sport:'Basketball', league:'NBA Summer League', game:'Chicago Bulls vs Memphis Grizzlies', pick:'Memphis Grizzlies ML', odds:'', grade:'B+', units:'0.75u', result:'Win', profitLoss:'Profit pending - odds needed', 'Profit/Loss':'Profit pending - odds needed', status:'Graded', settlementNotes:'Memphis won; posted odds were not stored.' },
  ...
  { date:'2026-07-10', section:'Lotto Parlays', access:'Free', sport:'Multi-Sport', league:'World Cup / WNBA / NBA Summer League', game:'Spain vs Belgium; Sky vs Sparks; Bulls vs Grizzlies', pick:'Spain to Advance + Sparks ML + Grizzlies ML', odds:'', grade:'B+', units:'0.50u', result:'Win', profitLoss:'Profit pending - odds needed', 'Profit/Loss':'Profit pending - odds needed', status:'Graded', settlementNotes:'All three legs won; posted parlay odds were not stored.' },
  { date:'2026-07-10', section:'Lotto Parlays', access:'Free', sport:'Multi-Sport', league:'World Cup / WNBA', game:'Spain vs Belgium; Sky vs Sparks', pick:'Spain to Advance + Sparks ML', odds:'', grade:'A-', units:'0.75u', result:'Win', profitLoss:'Profit pending - odds needed', 'Profit/Loss':'Profit pending - odds needed', status:'Graded', settlementNotes:'Both legs won; posted parlay odds were not stored.' },
...
export default async function handler(req, res) {
  ...
  res.status(200).json({
    ...
    summary:{record:stats.record,units:stats.units,profitLoss:stats.profitLoss,winRate:stats.winRate,totalPicks:results.length,gradedPicks:results.length,note:'Known units exclude three winning bets whose posted odds were not stored.'}
  })
}
