...
export const ACTIVE_TABLES = {
  picks: {
    ...
    label: 'Picks',
    section: 'picks',
    env: ['AIRTABLE_PICKS_TABLE_ID', 'AIRTABLE_PICKS_TABLE_NAME', 'AIRTABLE_MASTER_PICKS_TABLE_ID', 'AIRTABLE_MASTER_PICKS_TABLE_NAME', 'AIRTABLE_MASTER_PICKS_TABLE'],
  ...
  propsLab: {
    ...
    label: 'Props Lab',
    section: 'props',
    env: ['AIRTABLE_PROPS_LAB_TABLE_ID', 'AIRTABLE_PROPS_LAB_TABLE_NAME', 'AIRTABLE_PROPS_TABLE_ID', 'AIRTABLE_PROPS_TABLE_NAME', 'AIRTABLE_PROPS_TABLE'],
    fallback: 'Props Lab',
  ...
  lottoParlays: {
    ...
    label: 'Lotto Parlays',
    section: 'lotto',
    env: ['AIRTABLE_LOTTO_PARLAYS_TABLE_ID', 'AIRTABLE_LOTTO_PARLAYS_TABLE_NAME', 'AIRTABLE_PARLAYS_TABLE_ID', 'AIRTABLE_PARLAYS_TABLE_NAME', 'AIRTABLE_LOTTO_TABLE_ID', 'AIRTABLE_LOTTO_TABLE_NAME', 'AIRTABLE_LOTTO_TABLE'],
  ...
  longshots: {
    ...
    label: 'Longshots',
    section: 'longshots',
    env: ['AIRTABLE_LONGSHOTS_TABLE_ID', 'AIRTABLE_LONGSHOTS_TABLE_NAME', 'AIRTABLE_LONGSHOTS_TABLE'],
    fallback: 'Longshots',
...
export const RESULTS_ARCHIVE_TABLE = {
  ...
  section: 'results',
  env: ['AIRTABLE_RESULTS_ARCHIVE_TABLE_ID', 'AIRTABLE_RESULTS_ARCHIVE_TABLE_NAME', 'AIRTABLE_RESULTS_ARCHIVE_TABLE', 'AIRTABLE_RESULTS_TABLE_ID', 'AIRTABLE_RESULTS_TABLE_NAME', 'AIRTABLE_RESULTS_TABLE'],
